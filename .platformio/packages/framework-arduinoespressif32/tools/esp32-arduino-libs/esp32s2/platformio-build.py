...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "ulp", "ulp_riscv", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "ulp", "ulp_riscv", "shared", "include"),
