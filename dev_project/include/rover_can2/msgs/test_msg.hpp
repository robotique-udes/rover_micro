...
namespace RoverCan2::Msgs
{
    ...
    TestMsg::eLoadMsgCode TestMsg::loadMsg(const CanMsg& msg)
    {
    ...
    std::optional<CanMsg> TestMsg::getCanMsg(const uint8_t msgContentId_) const
    {
    ...
    uint8_t TestMsg::getMsgContentCount(void) const
    {
