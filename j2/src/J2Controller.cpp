...
J2Controller::J2Controller(Stream *serial_) 
{
    ...
    //SJ2Controller::motorSerial->begin(J2Controller::UART_BAUD_RATE, SERIAL_8N1, J2Controller::UART_RX_PIN, J2Controller::UART_TX_PIN);
...
void J2Controller::readMotorParameters(bool verbose) 
{
  ...
  if (J2Controller::motorSerial->available()) {
    ...
    index += 2;
    J2Controller::param_outputCurrent = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 100.0;
    index += 4;
    J2Controller::param_inputCurrent = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 100.0;
    index += 4;
    J2Controller::param_idCurrent = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 100.0;
    index += 4;
    J2Controller::param_iqCurrent = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 100.0;
    index += 4;
    J2Controller::param_throttleValue = (int16_t)((response[index] << 8) | response[index + 1]) / 1000.0;
    index += 2;
    J2Controller::param_motorSpeed = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]);
    index += 4;
    ...
    index += 1;
    J2Controller::param_motorOuterLoopPosition = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 1000000.0;
    index += 4;
    J2Controller::param_motorIdNumber = response[index];
    index += 1;
    index += 6; // Skip Temperature Reserved Value
    J2Controller::param_vdVoltage = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 1000.0;
    index += 4;
    J2Controller::param_vqVoltage = (int32_t)((response[index] << 24) | (response[index + 1] << 16) | (response[index + 2] << 8) | response[index + 3]) / 1000.0;
    index += 4;
