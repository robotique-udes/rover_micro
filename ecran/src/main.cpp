...
void labyrinthe(){
  ...
  //int etatswitch4 = digitalRead(switch4);
    while (ledlaby < 4){ //allumer et eteindre 4 DEL pour avoir pts
      ...
      else if (LED_goal==2 && digitalRead(switch2)==LOW){ //qd ca marchait cetait else if 
      digitalWrite(LED2,LOW); //eteindre LED
      ledlaby++;
      LED_goal =random(1,4);
      initLaby(); //allumer nouvelle LED
      }
      else if (LED_goal == 3 && digitalRead(switch3)==LOW){ //qd ca marchait cetait else if 
      digitalWrite(LED3,LOW); //eteindre LED
      ledlaby++;
      LED_goal =random(1,4);
      initLaby(); //allumer nouvelle LED
      }
      else if (LED_goal == 4 && digitalRead(switch4)== LOW){ //qd ca marchait cetait else if 
...
/*
  ...
  //Ecran
    ...
    //Labyrinthe aleatoire allume DEL
    LED_goal = random(1,4);
    initLaby();
    ...
    if(digitalRead(SW3) == LOW && counter3==number_goal && currentCLK3 !=lastCLK3){
