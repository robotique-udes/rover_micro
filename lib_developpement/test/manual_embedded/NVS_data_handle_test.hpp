...
void setup(void)
{
    ...
    NVSDataHandle<int32_t> someValue("test_ns", "turn_ctn", 0L);

    LOG_INFO(Logger::Nodes::Main, "Current value: %li", someValue.getValue());
    someValue.writeValue(-150L);
    LOG_INFO(Logger::Nodes::Main, "Value saved: %li", someValue.getValue());
