/**
 * ESP32-S3 SPI2 driver for IFX9201SG motor controller
 *
 * This example demonstrates SPI communication with the IFX9201SG
 * motor controller chip using the ESP32-S3's SPI2 peripheral.
 */
