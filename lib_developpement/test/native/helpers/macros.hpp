...
TEST(SUITE_HELPER_Macro, _MAP)
{
    ...
    EXPECT_FLOAT_EQ(MAP(0, 0, 10, 0, 100), 0.0f);
    EXPECT_FLOAT_EQ(MAP(10, 0, 10, 0, 100), 100.0f);
    EXPECT_FLOAT_EQ(MAP(-5, -10, 0, 0, 100), 50.0f);
    EXPECT_FLOAT_EQ(MAP(0, 0, 10, 100, 0), 100.0f);
    EXPECT_FLOAT_EQ(MAP(10, 0, 10, 100, 0), 0.0f);
    EXPECT_FLOAT_EQ(MAP(15, 0, 10, 0, 100), 150.0f);
    EXPECT_FLOAT_EQ(MAP(-5, 0, 10, 0, 100), -50.0f);
}
